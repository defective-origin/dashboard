import { Guide, GuideModel, PATHNAME } from './Guide.model'


let savedRecord: Guide
const MOCK_OPERATION_RECORD = { name: 'OPERATION_NAME', content: 'OPERATION_CONTENT' }
const MOCK_SAVED_RECORD = { name: 'NAME_1', content: 'NAME_1@mail.com' }
const MOCK_SAVED_RECORDS = [MOCK_SAVED_RECORD]

describe(`[${PATHNAME}] api`, () => {
  beforeEach(async () => {
    savedRecord = await GuideModel.create(MOCK_SAVED_RECORD)
  })
  ...
  describe('[create] endpoint', () => {
    it('should create new record', async () => {
      ...
      const record = await GuideModel.findOne(MOCK_OPERATION_RECORD)
  ...
  describe('[delete] endpoint', () => {
    it('should delete record by id', async () => {
      ...
      const record = await GuideModel.findOne(MOCK_SAVED_RECORD)
