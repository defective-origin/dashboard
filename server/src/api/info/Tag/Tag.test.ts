import { Tag, TagModel, PATHNAME } from './Tag.model'


let savedRecord: Tag
const MOCK_OPERATION_RECORD = { name: 'OPERATION_NAME', content: 'OPERATION_CONTENT' }
const MOCK_SAVED_RECORD = { name: 'NAME', content: 'CONTENT' }
const MOCK_SAVED_RECORDS = [MOCK_SAVED_RECORD]

describe(`[${PATHNAME}] api`, () => {
  beforeEach(async () => {
    savedRecord = await TagModel.create(MOCK_SAVED_RECORD)
  })
  ...
  describe('[create] endpoint', () => {
    it('should create new record', async () => {
      ...
      const record = await TagModel.findOne(MOCK_OPERATION_RECORD)
  ...
  describe('[delete] endpoint', () => {
    it('should delete record by id', async () => {
      ...
      const record = await TagModel.findOne(MOCK_SAVED_RECORD)
