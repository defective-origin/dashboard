import { User, UserModel, PATHNAME } from './User.model'


let savedRecord: User
const MOCK_OPERATION_RECORD = { name: 'OPERATION_NAME', email: 'OPERATION_NAME@mail.com' }
const MOCK_SAVED_RECORD = { name: 'NAME_1', email: 'NAME_1@mail.com' }
const MOCK_SAVED_RECORDS = [MOCK_SAVED_RECORD]

describe(`[${PATHNAME}] api`, () => {
  beforeEach(async () => {
    savedRecord = await UserModel.create(MOCK_SAVED_RECORD)
  })
  ...
  describe('[create] endpoint', () => {
    it('should create new record', async () => {
      ...
      const record = await UserModel.findOne(MOCK_OPERATION_RECORD)
  ...
  describe('[delete] endpoint', () => {
    it('should delete record by id', async () => {
      ...
      const record = await UserModel.findOne(MOCK_SAVED_RECORD)
