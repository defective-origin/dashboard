import { Event, EventModel, PATHNAME } from './Event.model'


let savedRecord: Event
...
describe(`[${PATHNAME}] api`, () => {
  beforeEach(async () => {
    savedRecord = await EventModel.create(MOCK_SAVED_RECORD)
  })
  ...
  describe('[create] endpoint', () => {
    it('should create new record', async () => {
      ...
      const record = await EventModel.findOne(MOCK_OPERATION_RECORD)
