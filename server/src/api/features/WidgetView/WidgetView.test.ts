import { WidgetView, WidgetViewModel, PATHNAME } from './WidgetView.model'


let savedRecord: WidgetView
const MOCK_OPERATION_RECORD = { name: 'OPERATION_NAME' }
const MOCK_SAVED_RECORD = { name: 'NAME_1' }
const MOCK_SAVED_RECORDS = [MOCK_SAVED_RECORD]

describe(`[${PATHNAME}] api`, () => {
  beforeEach(async () => {
    savedRecord = await WidgetViewModel.create(MOCK_SAVED_RECORD)
  })
  ...
  describe('[create] endpoint', () => {
    it('should create new record', async () => {
      ...
      const record = await WidgetViewModel.findOne(MOCK_OPERATION_RECORD)
  ...
  describe('[delete] endpoint', () => {
    it('should delete record by id', async () => {
      ...
      const record = await WidgetViewModel.findOne(MOCK_SAVED_RECORD)
