...
import { Translate, TranslateModel, PATHNAME } from './Translate.model'
...
describe(`[${PATHNAME}] api`, () => {
  beforeEach(async () => {
    savedRecord = await TranslateModel.create(MOCK_SAVED_RECORD)
  })
  ...
  describe('[create] endpoint', () => {
    it('should create new record', async () => {
      ...
      const record = await TranslateModel.findOne({ name: MOCK_OPERATION_RECORD.name })
  ...
  describe('[delete] endpoint', () => {
    it('should delete record by id', async () => {
      ...
      const record = await TranslateModel.findOne(MOCK_SAVED_RECORD)
