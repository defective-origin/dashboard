import { Board, BoardModel, PATHNAME } from './Board.model'
...
describe(`[${PATHNAME}] api`, () => {
  beforeEach(async () => {
    savedRecord = await BoardModel.create(MOCK_SAVED_RECORD)
  })
  ...
  describe('[create] endpoint', () => {
    it('should create new record', async () => {
      ...
      const record = await BoardModel.findOne({ name: MOCK_OPERATION_RECORD.name })
  ...
  describe('[delete] endpoint', () => {
    it('should delete record by id', async () => {
      ...
      const record = await BoardModel.findOne(MOCK_SAVED_RECORD)
