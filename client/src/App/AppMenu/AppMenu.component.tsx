  ...
  return (
    <Aside className={_className} as='nav' v='tcb' {...otherProps}>
      ...
      <Actions className={css.Main} v='y' grow={1}>
        ...
        <Actions.Nav start='apps' to='APPS' tooltip={t('LABEL.APPS')} tooltipSide='right' size='lg' />
        ...
        <Actions.Nav start='package_2' to='PACKAGES' tooltip={t('LABEL.PACKAGES')} tooltipSide='right' size='lg' />
