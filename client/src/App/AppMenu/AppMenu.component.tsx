  ...
  return (
    <Aside className={_className} as='nav' v='tcb' {...otherProps}>
      ...
      <Actions className={css.Main} v='y' grow={1}>
        <Actions.Nav start='data_thresholding' to='WIDGET_VIEWS' tooltip={t('LABEL.WIDGET_VIEWS')} tooltipSide='right' size='lg' />
        <Actions.Nav start='insert_chart' to='WIDGETS' tooltip={t('LABEL.WIDGETS')} tooltipSide='right' size='lg' />
