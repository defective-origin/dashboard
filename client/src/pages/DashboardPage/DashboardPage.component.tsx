...
import { BoardMarkupDevice, BoardMarkupItem, useBoard, useBoardMutations } from 'api'
...
export function DashboardPage(props: DashboardPageProps) {
  ...
  const [mode, setMode] = useState<boolean | BoardMarkupItem | undefined>(false)
  ...
  const handleReselect = (item: BoardMarkupItem) => {
  ...
  // TODO: copy layout to another device markups if it's not configured yet or add button


  // background: repeating-linear-gradient(45deg, white, white 9px, rgb(248, 248, 248) 9px, rgb(248, 248, 248) 14px);
  ...
  return (
    <FeaturePage
      ...
      nav={
        <ButtonGroup
          ...
          items={[
            ...
            // <ButtonGroup.Button start='watch' tooltip={t('DEVICE.WATCH')} active={isMarkupActive('WATCH')} onClick={() => setMarkupDevice('WATCH')} />
          ]}
        />
      }
      menu={[
      ...
      onAdd={() => console.log('CREATE CLONE')}
      {...otherProps}
    >
