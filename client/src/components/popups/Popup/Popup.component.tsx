...
const POPUP_STYLE = { tooltip: { style: { background: 'var(--card-background)', border: 'var(--border)', boxShadow: 'var(--box-shadow)' } } }
const POPUP_WITHOUT_ARROW_STYLE = { tooltip: { style: { margin: 0, padding: 0, ...POPUP_STYLE.tooltip.style } } }
        ...
        >
          ...
          <Footer>
            <ButtonGroup
              ...
              items={mix.fromValOrFunc(actions, toggler)}
            />
          </Footer>
        </Layout>
      )}
