...
export function formField<P extends FieldProps,>(cmp: React.ComponentType<P>, formFieldProps?: Partial<FormFieldProps>) {
  return (props: Omit<FormFieldProps, 'as'> & P) => <FormField {...props} {...formFieldProps} as={cmp as React.ComponentType} />
}
